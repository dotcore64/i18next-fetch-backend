  ...
  it('should fail to load non existent language translation', (cb) => {
    ...
    i18next
      ...
      .init({
        ...
        expect(err).to.deep.equal(['failed loading http://localhost:3000/de/translation.json']);
  ...
  it('should fail to load non existent namespace translation', (cb) => {
    ...
    i18next
      ...
      .init({
        ...
        expect(err).to.deep.equal(['failed loading http://localhost:3000/en/mynamespace.json']);
